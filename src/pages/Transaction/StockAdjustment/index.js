...
const StockAdjustment = (props) => {
  ...
  const { data, isLoading, isFetching } = useStockadjustmentQuery({
    ...params,
    keywords,
    page,
    per_page,
  ...
  const [sellerDelete] = useStockadjustmentdeleteMutation();
  const [filter_status, setFilterStatus] = useState('Pending');
  const [sellerUpdate] = useStockadjustmentupdateMutation();
  ...
  const transformDate = (input) => {
    ...
    const month = ('0' + (inputDate.getMonth() + 1)).slice(-2); // Adding 1 to the month because months are zero-indexed
  ...
  return (
    <div className="page-content list-items">
      ...
      <Container fluid>
        <BreadCrumb title="Stock Adjustments" pageTitle="Stock Adjustments" />
        {alert.success === true ? (
          <MsgToast
            msg={alert.message}
            color="success"
              ...
              <div className="card-header border-0">
                <div className="row g-4">
                  <div className="col-sm-auto">
                    <div>
                      <Link to="/app/sadj/new" className="btn btn-success">
                  ...
                  <div className="col-sm">
                    <div className="d-flex justify-content-sm-end">
                      <div className="col-12 col-sm-12 col-lg-4 col-xl-3 me-2">
              ...
              <div className="card-body">
                ...
                >
                  {isLoading || isFetching ? (
                    ...
                    <div>
                      <BTable data={stock_adjustment_list} columns={columns} />
                    </div>
                  ) : (
                    <div className="py-4 text-center">
                      <div>
